...
void init_conf(const RunProgramConfig &config) {
	...
	if (config.type == "python2.7") {
		...
		readable_file_name_set.insert("/usr/bin/python3.5");
		readable_file_name_set.insert("/usr/lib/python3.5/");
		readable_file_name_set.insert("/usr/lib/python3/");
		readable_file_name_set.insert("/usr/bin/lib/python3.5/");
		readable_file_name_set.insert("/usr/local/lib/python3.5/");
